...
public class Main {
    ...
    private static void daftarAdmin() {
        ...
        try {
            ...
            if (AdminAuth.isUsernameExists(username)) {
                print(RED, "Username sudah dipakai.");
                return;
            }
            String password = readString("Password : ");
    ...
    private static void tambahPaket() throws SQLException {
        ...
        if (customers.isEmpty()) {
            print(RED, "Tambah customer dulu.");
            return;
        }
    ...
    private static void updateStatus() throws SQLException {
        ...
        if (pkg == null) {
            print(RED, "Paket tidak ditemukan.");
            return;
        }
    ...
    private static void trackingPaket() {
        ...
        try {
            Package pkg = packageMapper.findById(id);
            if (pkg == null) {
                print(RED, "Nomor resi tidak ditemukan.");
                return;
            }
